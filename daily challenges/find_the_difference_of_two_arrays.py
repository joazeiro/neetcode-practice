...
1. answer[0] is a list of all distinct integers in nums1 which 
are not present in nums2.
2. answer[1] is a list of all distinct integers in nums2 which 
...
nums2[1] = 4 and nums2[2] = 6 are not present in nums2. 
...
class Solution:
    def findDifference(self, nums1: List[int], nums2: List[int]) -> List[List[int]]:
        ...
        answer.append(set(union1))
        answer.append(set(union2))
